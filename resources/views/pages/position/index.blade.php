                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                        <thead style="background-color: #2A3F54;">
                                            <tr>
                                                ...
                                                <th class="text-center text-light">Nama Jabatan</th>
        ...
        <div class="modal-content">
            <form id="form_create">
                <div class="modal-header" style="background-color: #32a893;">
                    <h5 class="modal-title text-white">Tambah Jabatan</h5>
                    <button
                        type="button"
                        class="close"
                        data-dismiss="modal">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="form_edit">
                ...
                <div class="modal-header" style="background-color: #32a893;">
                    <h5 class="modal-title text-white">Ubah Jabatan</h5>
                    <button
                        type="button"
                        class="close"
                        data-dismiss="modal">
...
<script>
    $(document).ready(function() {
        ...
        $('body').on('click', '.btn-edit', function(e) {
            ...
            var url = '{{ route("position.edit", ":id") }}';
        ...
        $('body').on('click', '.btn-delete', function(e) {
            ...
            var id = $(this).attr('data-id');
            var url = '{{ route("position.delete_btn", ":id") }}';
            url = url.replace(':id', id );
