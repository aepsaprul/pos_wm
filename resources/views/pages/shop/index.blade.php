              ...
              <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                <thead class="bg-info">
                  <tr>
                    ...
                    <th class="text-center text-light">Email & Rekening</th>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @if($item->nomor_rekening)
                            <br> <span class="text-sm">{{ $item->nomor_rekening }} a.n {{ $item->an_rekening }}</span>
                          @endif
                        </td>
                        <td>{{ $item->address }}</td>
    ...
    <div class="modal-content">
      <form id="form_create">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="create_nomor_rekening" class="form-label">Nomor Rekening</label>
            <input type="text" class="form-control form-control-sm" id="create_nomor_rekening" name="create_nomor_rekening" maxlength="50">
          </div>
          <div class="mb-3">
            <label for="create_an_rekening" class="form-label">Rekening Atas Nama</label>
            <input type="text" class="form-control form-control-sm" id="create_an_rekening" name="create_an_rekening" maxlength="50">
          </div>
        </div>
      ...
      <form id="form_edit">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control form-control-sm" id="edit_nomor_rekening" name="edit_nomor_rekening" maxlength="50">
          </div>
          <div class="mb-3">
            <label for="edit_an_rekening" class="form-label">Rekening Atas Nama</label>
            <input type="text" class="form-control form-control-sm" id="edit_an_rekening" name="edit_an_rekening" maxlength="50">
          </div>
        </div>
        <div class="modal-footer">
  ...
  $(document).ready(function() {
    ...
    $('#form_create').submit(function(e) {
      ...
      var formData = {
        ...
        nomor_rekening: $('#create_nomor_rekening').val(),
        an_rekening: $('#create_an_rekening').val()
      }
    ...
    $('body').on('click', '.btn-edit', function(e) {
      ...
      $.ajax({
        ...
        data: formData,
        success: function(response) {
          $('#edit_id').val(response.shop.id);
          $('#edit_name').val(response.shop.name);
          $('#edit_contact').val(response.shop.contact);
          $('#edit_email').val(response.shop.email);
          $('#edit_address').val(response.shop.address);
          $('#edit_nomor_rekening').val(response.shop.nomor_rekening);
          $('#edit_an_rekening').val(response.shop.an_rekening);

          let val_category = "<option value=\"\">--Pilih Kategori--</option>" +
          "<option value=\"gudang\"";
          if (response.shop.category == "gudang") {
            val_category += " selected";
          }
          val_category += ">Gudang</option>" +
          "<option value=\"toko\"";
          if (response.shop.category == "toko") {
            val_category += " selected";
          }
    ...
    $('#form_edit').submit(function(e) {
      ...
      var formData = {
        ...
        an_rekening: $('#edit_an_rekening').val()
      }
